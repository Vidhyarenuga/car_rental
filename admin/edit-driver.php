...
$sql="update tbldriver set VehiclesTitle=:vehicletitle,VehiclesOverview=:vehicleoverview,PricePerDay=:priceperday,FuelType=:fueltype,ModelYear=:modelyear where id=:id ";
...
<?php 
$id=intval($_GET['id']);
$sql ="select * from tbldriver where id=:id";
$query = $dbh -> prepare($sql);
$query-> bindParam(':id', $id, PDO::PARAM_STR);
$query->execute();
...
<a href="changedrimage1.php?imgid=<?php echo htmlentities($result->id)?>">Change Image 1</a>
</div>
<div class="col-sm-4">
...
<div class="col-md-12">
<div class="panel panel-default">
<div class="panel-heading">Update Driver Detials</div>
<div class="panel-body">


<div class="form-group">
<div class="col-sm-3">
<button class="btn btn-primary" name="submit" type="submit" style="margin-top:4%">Save changes</button>										<div class="form-group">
</div>
