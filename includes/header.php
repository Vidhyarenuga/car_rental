    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-3 col-md-2">
          <div class="logo"> <a href="index.php"><img src="assets/images/logo1.png" alt="image" width="211" height="109"/></a> </div>
        </div>
...
?>
 <form method="post">
              ...
              <h6>Subscribe Car Rental ! Get Update</h6>
	 ...
	 echo htmlentities($result->FullName); }}?><i class="fa fa-angle-down" aria-hidden="true"></i></a>
      ...
      <div class="collapse navbar-collapse" id="navigation">
        <ul class="nav navbar-nav">
          ...
          <li><a href="page.php?type=faqs">Drivers Listing</a></li>
